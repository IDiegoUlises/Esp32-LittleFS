...
| a+ | Abrir para leer y agregar, el archivo se crea si no existe la posicion inicial del archivo para lectura es al principio del archivo, pero la salida siempre se agrega al final del archivo |
